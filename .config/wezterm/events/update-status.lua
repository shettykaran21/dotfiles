...
e.__get_width = function(pane, window)
...
---Updates the width calculations for the window, returning the remaining usable width.
---
---@return number usable_width remaining usable width
e.update_width = function()
  return e.width.usable - (e.width.mode + e.width.ws)
end -- }}}
...
wt.on("update-status", function(window, pane)
  ...
  e.width = e.__get_width(pane, window)

  e.set_left_status(window)

  e.width.usable = e.update_width()
