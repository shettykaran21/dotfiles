...
local mappings = {
  ...
  { "<W-S-c>", act.CopyTo "Clipboard", "copy" },
  { "<W-S-v>", act.PasteFrom "Clipboard", "paste" },
  { "<W-S-f>", act.Search "CurrentSelectionOrEmptyString", "search" },
  { "<W-S-k>", act.ClearScrollback "ScrollbackOnly", "clear scrollback" },
  { "<W-S-l>", act.ShowDebugOverlay, "debug overlay" },
  { "<W-S-n>", act.SpawnWindow, "new window" },
  { "<W-S-p>", act.ActivateCommandPalette, "command palette" },
  { "<W-S-r>", act.ReloadConfiguration, "reload config" },
  { "<W-S-t>", act.SpawnTab "CurrentPaneDomain", "new pane" },
  {
    "<W-S-u>",
    act.CharSelect {
      copy_on_select = true,
  ...
  { "<W-S-w>", act.CloseCurrentTab { confirm = true }, "close tab" },
  { "<W-S-z>", act.TogglePaneZoomState, "toggle zoom" },
  { "<PageUp>", act.ScrollByPage(-1), "" },
  { "<PageDown>", act.ScrollByPage(1), "" },
  { "<W-S-Insert>", act.PasteFrom "PrimarySelection", "" },
  { "<W-Insert>", act.CopyTo "PrimarySelection", "" },
  { "<W-S-Space>", act.QuickSelect, "quick select" },
  {
    "<S-M-t>",
